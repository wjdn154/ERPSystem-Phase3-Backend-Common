...
public class LoadDashboardFromS3 implements Tasklet {
    ...
    public LoadDashboardFromS3(S3DashboardService s3DashboardService) {
        this.s3DashboardService = s3DashboardService;
    }

    @Override
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        String s3Key = "dashboard-1월.json "; // S3에서 가져올 데이터의 키
