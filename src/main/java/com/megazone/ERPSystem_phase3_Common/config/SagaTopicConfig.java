...
public class SagaTopicConfig {
    ...
    @Bean
    public CommandLineRunner sagaStartTopicExists(KafkaAdmin kafkaAdmin) {
        return args -> {
    ...
    @Bean
    public CommandLineRunner sagaResponseTopicExists(KafkaAdmin kafkaAdmin) {
        return args -> {
            String topicName = "saga-response";
